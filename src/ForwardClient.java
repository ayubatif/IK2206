...
public class ForwardClient
{
    ...
    private static void doHandshake() throws IOException {
        ...
        cHelloMsg.put("MessageType", "ClientHello");
        cHelloMsg.send(socket);
		HandshakeMessage sHelloMsg = new HandshakeMessage();

		HandshakeMessage frwardMsg = new HandshakeMessage();
		HandshakeMessage sesionMsg = new HandshakeMessage();
		sHelloMsg.put("MessageType", "ServerHello");
		frwardMsg.put("MessageType", "Forward");
		sesionMsg.put("MessageType", "Session");
        socket.close();
